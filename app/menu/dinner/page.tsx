...
export default function Dinner() {
  return (
    <div className="grid md:grid-cols-2 items-start max-w-6xl px-4 mx-auto py-6 gap-6 md:gap-12 bg-white">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-2">
          ...
          <form className="grid gap-4 md:gap-10">
            <div className="grid gap-2">
              ...
              >
                <Label
                  className="border border-black cursor-pointer rounded-md p-2 flex items-center gap-2 [&:has(:checked)]:bg-gray-100 dark:[&:has(:checked)]:bg-gray-500"
                  htmlFor="size-6"
                >
            ...
            <div className="grid gap-2">
              ...
              <Select defaultValue="1">
                ...
                <SelectContent className="bg-opacity-100">
