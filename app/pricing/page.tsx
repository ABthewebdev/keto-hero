    ...
    <div className="bg-gray-900 bg-opacity-0">
      <div className="px-6 pt-12 lg:px-8 lg:pt-20">
        <div className="text-center">
          <h2 className="text-xl font-semibold leading-6 text-black">
            Pricing
          </h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-800 sm:text-4xl lg:text-5xl">
            The right price for you, whoever you are
          </p>
          <p className="mx-auto mt-3 max-w-4xl text-xl text-black sm:mt-5 sm:text-2xl">
